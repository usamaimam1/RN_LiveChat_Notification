                ...
                <View style={styles.IssuesView}>
                    {this.props.issues.length === 0 ?
                        <View style={{ alignItems: 'center', justifyContent: 'center' }}>
                            <Text style={{ fontFamily: "Montserrat", fontSize: RFValue(14), fontWeight: "400", color: "grey" }}>No Issues To Display</Text>
                        </View> :
...
const styles = StyleSheet.create({
    ...
    HeaderTitle: {
        fontFamily: "Montserrat", marginLeft: wp(4.533), fontSize: RFValue(12), color: '#34304C', fontWeight: "bold", flex: 1
    },
