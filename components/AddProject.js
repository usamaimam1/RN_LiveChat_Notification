...
export default class AddProject extends React.Component {
    ...
    handleSubmit() {
        ...
        uuid.then(val => {
            ...
            const toUpload = {
                projectId: val,
                projectmanager: { [projectManager]: { isAllowed: true, uid: this.state.AdminData.uid, profilepic: this.state.AdminData.profilepic, fullName: this.state.AdminData.fullName } },
                teammembers: '',
                teamleads: '',
                    ...
                    <KeyboardAwareScrollView>
                        ...
                        <View style={{ flex: 1, margin: 5 }}>
                            ...
                            {this.state.projectThumbnail.uri ?
                                <Image style={{ height: 150, width: 150, alignSelf: 'center' }} source={this.state.projectThumbnail}>
                                </Image> : null
                                }
