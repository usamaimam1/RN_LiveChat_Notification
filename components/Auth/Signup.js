                            ...
                            <View style={styles.SignUpView}>
                                <View style={styles.ProfilePictureView}>
                                    {this.state.imgSource ?
                                        <Image style={styles.Avatar} source={this.state.imgSource} resizeMode="contain" onPress={this.handlePickImage}></Image> :
...
const styles = StyleSheet.create({
    ...
    Avatar: {
        width: wv(100), height: hv(100), borderRadius: 100
    },
    UploadButton: {
        alignSelf: 'center',
