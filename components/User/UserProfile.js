                    ...
                    <View style={styles.Footer}>
                        <View style={styles.ProjectsIcon} onPress={() => { this.props.navigation.navigate('Dashboard') }}>
                            <View style={{ height: RFValue(16), width: RFValue(16), alignSelf: 'flex-start', backgroundColor: '#F48A20', borderRadius: RFValue(10), borderWidth: 0 }}>
                                <Text style={{ fontFamily: "Montserrat", fontSize: RFValue(11), alignSelf: 'center', color: 'white' }}>{this.props.projectCount}</Text>
                            </View>
...
const styles = StyleSheet.create({
    ...
    StatusText: { fontSize: RFValue(12), fontWeight: '500', fontFamily: "Montserrat", },
    NameEmailView: { alignSelf: 'center', height: hv(56), marginTop: hv(11.5) },
    Name: { fontSize: RFValue(26), alignSelf: 'center', fontFamily: "Montserrat", },
    Email: { fontSize: RFValue(14), color: '#758692', alignSelf: 'center', marginTop: hv(6), fontFamily: "Montserrat", },
    ...
    InfoText: { alignSelf: 'center', fontSize: RFValue(18), fontWeight: 'bold', fontFamily: "Montserrat", },
    InfoLabel: { marginTop: hv(5), fontSize: RFValue(12), color: '#758692', alignSelf: 'center', fontFamily: "Montserrat", },
    UpdateButton: { alignSelf: 'center', width: wv(100), height: hv(32), borderRadius: hv(32) / 2, marginTop: hv(26.5), backgroundColor: '#F48A20' },
    UpdateButtonText: { fontFamily: "Montserrat", color: 'white', textAlign: 'center', fontSize: RFValue(13), marginVertical: hv(8), marginHorizontal: wv(22), fontWeight: '500' },
